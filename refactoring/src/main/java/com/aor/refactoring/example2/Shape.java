...
/* CODE SMELLS:
   ->
   // Não há polimorfismo -> replace condictionals with polymorfism;
// Separar as duas classes triangle e rectangle -> shape tem metodos abstratos de area e perimetro
    e as subclasses tem implementação concreta,
 atributos comuns: posição, nao comuns: raio, altura, largura;
 */
